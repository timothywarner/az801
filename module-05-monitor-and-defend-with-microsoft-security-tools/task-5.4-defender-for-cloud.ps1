...
.DESCRIPTION
    ...
    Shows how to onboard servers to Defender for Cloud for security posture management.
...
try {
    Write-Host "[Step 1] Configure Microsoft Defender for Cloud - Overview" -ForegroundColor Yellow
    Write-Host "Shows how to onboard servers to Defender for Cloud for security posture management." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Configuration Steps" -ForegroundColor Yellow
    Write-Host "Configuring Configure Microsoft Defender for Cloud..." -ForegroundColor Cyan
    ...
    Write-Host "Best practices for Configure Microsoft Defender for Cloud:" -ForegroundColor Cyan
