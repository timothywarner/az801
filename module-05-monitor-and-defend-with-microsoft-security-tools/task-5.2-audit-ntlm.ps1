...
.DESCRIPTION
    ...
    Shows how to audit and monitor NTLM authentication usage in the domain.
...
try {
    Write-Host "[Step 1] Audit NTLM Authentication - Overview" -ForegroundColor Yellow
    Write-Host "Shows how to audit and monitor NTLM authentication usage in the domain." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Configuration Steps" -ForegroundColor Yellow
    Write-Host "Configuring Audit NTLM Authentication..." -ForegroundColor Cyan
    ...
    Write-Host "Best practices for Audit NTLM Authentication:" -ForegroundColor Cyan
