...
try {
    Write-Host "[Step 1] Troubleshoot Azure Arc - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates Azure Arc connectivity and agent troubleshooting." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Troubleshoot Azure Arc:" -ForegroundColor Cyan
