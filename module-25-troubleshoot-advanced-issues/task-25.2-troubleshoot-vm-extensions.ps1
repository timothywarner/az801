<#
.SYNOPSIS
    Task 25.2 - Troubleshoot VM Extensions

.DESCRIPTION
    Demo script for AZ-801 Module 25: Troubleshoot Advanced Issues
    Shows troubleshooting of Azure VM extensions.
...
Write-Host "=== AZ-801 Module 25: Task 25.2 - Troubleshoot VM Extensions ===" -ForegroundColor Cyan
Write-Host ""

try {
    Write-Host "[Step 1] Troubleshoot VM Extensions - Overview" -ForegroundColor Yellow
    Write-Host "Shows troubleshooting of Azure VM extensions." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Troubleshoot VM Extensions:" -ForegroundColor Cyan
