...
try {
    Write-Host "[Step 1] Troubleshoot Storage Issues - Overview" -ForegroundColor Yellow
    Write-Host "Shows storage troubleshooting for local and cluster storage." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Troubleshoot Storage Issues:" -ForegroundColor Cyan
