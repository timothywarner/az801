...
.DESCRIPTION
    ...
    Demonstrates physical server migration to Azure.
...
try {
    Write-Host "[Step 1] Migrate Physical Servers - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates physical server migration to Azure." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Migrate Physical Servers:" -ForegroundColor Cyan
