...
.DESCRIPTION
    ...
    Shows Active Directory replication troubleshooting.
...
try {
    Write-Host "[Step 1] Troubleshoot AD Replication - Overview" -ForegroundColor Yellow
    Write-Host "Shows Active Directory replication troubleshooting." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Troubleshoot AD Replication:" -ForegroundColor Cyan
