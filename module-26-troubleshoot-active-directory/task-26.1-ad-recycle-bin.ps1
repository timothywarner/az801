...
try {
    Write-Host "[Step 1] Use AD Recycle Bin - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates Active Directory Recycle Bin for object recovery." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Use AD Recycle Bin:" -ForegroundColor Cyan
