...
try {
    Write-Host "[Step 1] Recover SYSVOL - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates SYSVOL recovery and repair procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Recover SYSVOL:" -ForegroundColor Cyan
