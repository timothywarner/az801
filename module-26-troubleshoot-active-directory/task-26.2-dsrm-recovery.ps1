...
try {
    Write-Host "[Step 1] Perform DSRM Recovery - Overview" -ForegroundColor Yellow
    Write-Host "Shows Directory Services Restore Mode recovery procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Perform DSRM Recovery:" -ForegroundColor Cyan
