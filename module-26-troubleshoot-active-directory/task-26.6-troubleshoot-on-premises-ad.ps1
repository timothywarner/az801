...
.DESCRIPTION
    ...
    Shows common on-premises AD troubleshooting procedures.
...
try {
    Write-Host "[Step 1] Troubleshoot On-Premises AD - Overview" -ForegroundColor Yellow
    Write-Host "Shows common on-premises AD troubleshooting procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Troubleshoot On-Premises AD:" -ForegroundColor Cyan
