...
.DESCRIPTION
    ...
    Demonstrates migration to Azure Files using Azure File Sync.
...
try {
    ...
    Write-Host "Demonstrates migration to Azure Files using Azure File Sync." -ForegroundColor Cyan
    Write-Host ""
