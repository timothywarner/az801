...
.DESCRIPTION
    ...
    Demonstrates evaluation of AD migration strategies.
...
try {
    Write-Host "[Step 1] Choose AD Migration Method - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates evaluation of AD migration strategies." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Choose AD Migration Method:" -ForegroundColor Cyan
