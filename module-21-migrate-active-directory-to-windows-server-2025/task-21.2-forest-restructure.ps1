...
Write-Host "=== AZ-801 Module 21: Task 21.2 - Perform Forest Restructure ===" -ForegroundColor Cyan
Write-Host ""

try {
    Write-Host "[Step 1] Perform Forest Restructure - Overview" -ForegroundColor Yellow
    Write-Host "Shows AD forest restructuring procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Perform Forest Restructure:" -ForegroundColor Cyan
