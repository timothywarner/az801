...
.DESCRIPTION
    ...
    Demonstrates migration to new AD forest with trust relationships.
...
try {
    ...
    Write-Host "Demonstrates migration to new AD forest with trust relationships." -ForegroundColor Cyan
    Write-Host ""
