...
Write-Host "=== AZ-801 Module 21: Task 21.4 - Migrate to New Forest ===" -ForegroundColor Cyan
Write-Host ""

try {
    Write-Host "[Step 1] Migrate to New Forest - Overview" -ForegroundColor Yellow
    Write-Host "Shows inter-forest migration procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Migrate to New Forest:" -ForegroundColor Cyan
