...
.DESCRIPTION
    ...
    Shows network configuration for failover clusters.
...
try {
    Write-Host "[Step 1] Configure Cluster Network Adapters - Overview" -ForegroundColor Yellow
    Write-Host "Shows network configuration for failover clusters." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Configure Cluster Network Adapters..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Configure Cluster Network Adapters..." -ForegroundColor Cyan
