...
.DESCRIPTION
    ...
    Demonstrates rolling cluster OS upgrade process.
...
try {
    Write-Host "[Step 1] Upgrade Cluster Nodes - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates rolling cluster OS upgrade process." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Upgrade Cluster Nodes..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Upgrade Cluster Nodes..." -ForegroundColor Cyan
