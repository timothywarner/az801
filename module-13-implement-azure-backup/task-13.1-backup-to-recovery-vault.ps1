...
.DESCRIPTION
    ...
    Demonstrates Azure Backup deployment for on-premises servers.
...
try {
    Write-Host "[Step 1] Backup to Recovery Services Vault - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates Azure Backup deployment for on-premises servers." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Backup to Recovery Services Vault..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Backup to Recovery Services Vault..." -ForegroundColor Cyan
