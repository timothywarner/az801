...
.DESCRIPTION
    ...
    Demonstrates VM recovery to new Azure VM.
...
try {
    Write-Host "[Step 1] Recover to New VM - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates VM recovery to new Azure VM." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Recover to New VM..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Recover to New VM..." -ForegroundColor Cyan
