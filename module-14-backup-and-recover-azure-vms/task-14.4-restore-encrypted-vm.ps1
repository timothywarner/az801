...
.DESCRIPTION
    ...
    Shows recovery procedures for encrypted Azure VMs.
...
try {
    Write-Host "[Step 1] Restore Encrypted VM - Overview" -ForegroundColor Yellow
    Write-Host "Shows recovery procedures for encrypted Azure VMs." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Restore Encrypted VM..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Restore Encrypted VM..." -ForegroundColor Cyan
