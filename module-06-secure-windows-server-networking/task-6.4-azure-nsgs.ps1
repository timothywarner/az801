...
.DESCRIPTION
    ...
    Shows NSG configuration for Azure VMs and hybrid scenarios.
...
try {
    Write-Host "[Step 1] Configure Azure Network Security Groups - Overview" -ForegroundColor Yellow
    Write-Host "Shows NSG configuration for Azure VMs and hybrid scenarios." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Configuration Steps" -ForegroundColor Yellow
    Write-Host "Configuring Configure Azure Network Security Groups..." -ForegroundColor Cyan
    ...
    Write-Host "Best practices for Configure Azure Network Security Groups:" -ForegroundColor Cyan
