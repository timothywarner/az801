<#
.SYNOPSIS
    Task 18.2 - Migrate IIS

.DESCRIPTION
    Demo script for AZ-801 Module 18: Migrate Server Roles
    Shows IIS web server migration procedures and considerations.
...
Write-Host "=== AZ-801 Module 18: Task 18.2 - Migrate IIS ===" -ForegroundColor Cyan
Write-Host ""

try {
    Write-Host "[Step 1] Migrate IIS - Overview" -ForegroundColor Yellow
    Write-Host "Shows IIS web server migration procedures and considerations." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Migrate IIS:" -ForegroundColor Cyan
