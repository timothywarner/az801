...
.DESCRIPTION
    ...
    Shows management of Hyper-V replica servers.
...
try {
    Write-Host "[Step 1] Manage Replica Servers - Overview" -ForegroundColor Yellow
    Write-Host "Shows management of Hyper-V replica servers." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Manage Replica Servers..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Manage Replica Servers..." -ForegroundColor Cyan
