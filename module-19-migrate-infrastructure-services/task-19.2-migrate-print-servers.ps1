...
.DESCRIPTION
    ...
    Shows print server migration procedures.
...
try {
    Write-Host "[Step 1] Migrate Print Servers - Overview" -ForegroundColor Yellow
    Write-Host "Shows print server migration procedures." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Migrate Print Servers:" -ForegroundColor Cyan
