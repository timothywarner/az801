<#
.SYNOPSIS
    Task 19.3 - Perform In-Place Upgrade

.DESCRIPTION
    Demo script for AZ-801 Module 19: Migrate Infrastructure Services
    Demonstrates in-place OS upgrade procedures for Windows Server.
...
Write-Host "=== AZ-801 Module 19: Task 19.3 - Perform In-Place Upgrade ===" -ForegroundColor Cyan
Write-Host ""

try {
    Write-Host "[Step 1] Perform In-Place Upgrade - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates in-place OS upgrade procedures for Windows Server." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Perform In-Place Upgrade:" -ForegroundColor Cyan
