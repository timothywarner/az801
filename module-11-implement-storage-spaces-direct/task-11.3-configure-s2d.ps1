...
.DESCRIPTION
    ...
    Demonstrates S2D cluster deployment and configuration.
...
try {
    Write-Host "[Step 1] Configure Storage Spaces Direct - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates S2D cluster deployment and configuration." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Configure Storage Spaces Direct..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Configure Storage Spaces Direct..." -ForegroundColor Cyan
