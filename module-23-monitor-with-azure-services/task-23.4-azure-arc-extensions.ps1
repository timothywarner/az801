...
.DESCRIPTION
    ...
    Shows Azure Arc extension deployment for hybrid monitoring.
...
try {
    Write-Host "[Step 1] Deploy Azure Arc Extensions - Overview" -ForegroundColor Yellow
    Write-Host "Shows Azure Arc extension deployment for hybrid monitoring." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Deploy Azure Arc Extensions:" -ForegroundColor Cyan
