...
.DESCRIPTION
    ...
    Demonstrates update management for hybrid servers.
...
try {
    Write-Host "[Step 1] Use Azure Update Manager - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates update management for hybrid servers." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Use Azure Update Manager:" -ForegroundColor Cyan
