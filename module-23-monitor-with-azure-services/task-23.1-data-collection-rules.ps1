...
.DESCRIPTION
    ...
    Demonstrates DCR configuration for Azure Monitor.
...
try {
    Write-Host "[Step 1] Configure Data Collection Rules - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates DCR configuration for Azure Monitor." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Configure Data Collection Rules:" -ForegroundColor Cyan
