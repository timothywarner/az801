...
.DESCRIPTION
    ...
    Shows alert creation and action groups in Azure Monitor.
...
try {
    Write-Host "[Step 1] Create Azure Monitor Alerts - Overview" -ForegroundColor Yellow
    Write-Host "Shows alert creation and action groups in Azure Monitor." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Create Azure Monitor Alerts:" -ForegroundColor Cyan
