...
.DESCRIPTION
    ...
    Demonstrates containerization of IIS applications.
...
try {
    Write-Host "[Step 1] Migrate to Containers - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates containerization of IIS applications." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Migrate to Containers:" -ForegroundColor Cyan
