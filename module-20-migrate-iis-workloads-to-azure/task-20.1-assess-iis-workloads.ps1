...
.DESCRIPTION
    ...
    Demonstrates assessment of IIS workloads for Azure migration.
...
try {
    Write-Host "[Step 1] Assess IIS Workloads - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates assessment of IIS workloads for Azure migration." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Assess IIS Workloads:" -ForegroundColor Cyan
