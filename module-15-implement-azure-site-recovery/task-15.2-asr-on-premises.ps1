...
.DESCRIPTION
    ...
    Shows ASR setup for on-premises to Azure scenarios.
...
try {
    Write-Host "[Step 1] Configure ASR for On-Premises - Overview" -ForegroundColor Yellow
    Write-Host "Shows ASR setup for on-premises to Azure scenarios." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Configure ASR for On-Premises..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Configure ASR for On-Premises..." -ForegroundColor Cyan
