...
.DESCRIPTION
    ...
    Demonstrates File Server Resource Manager and Storage Quality of Service.
...
try {
    Write-Host "[Step 1] Configure FSRM and Storage QoS - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates File Server Resource Manager and Storage Quality of Service." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Configuration Steps" -ForegroundColor Yellow
    Write-Host "Configuring Configure FSRM and Storage QoS..." -ForegroundColor Cyan
    ...
    Write-Host "Best practices for Configure FSRM and Storage QoS:" -ForegroundColor Cyan
