...
.DESCRIPTION
    ...
    Shows predictive analytics with System Insights.
...
try {
    Write-Host "[Step 1] Use System Insights - Overview" -ForegroundColor Yellow
    Write-Host "Shows predictive analytics with System Insights." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Use System Insights:" -ForegroundColor Cyan
