...
.DESCRIPTION
    ...
    Demonstrates performance monitoring using Windows Admin Center.
...
try {
    Write-Host "[Step 1] Monitor with Windows Admin Center - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates performance monitoring using Windows Admin Center." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Monitor with Windows Admin Center:" -ForegroundColor Cyan
