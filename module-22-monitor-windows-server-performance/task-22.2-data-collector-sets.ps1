...
.DESCRIPTION
    ...
    Shows configuration of data collector sets for performance baselines.
...
try {
    Write-Host "[Step 1] Configure Data Collector Sets - Overview" -ForegroundColor Yellow
    Write-Host "Shows configuration of data collector sets for performance baselines." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Configure Data Collector Sets:" -ForegroundColor Cyan
