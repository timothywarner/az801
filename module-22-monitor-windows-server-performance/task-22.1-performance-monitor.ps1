...
.DESCRIPTION
    ...
    Demonstrates Performance Monitor for real-time performance analysis.
...
try {
    Write-Host "[Step 1] Use Performance Monitor - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates Performance Monitor for real-time performance analysis." -ForegroundColor White
    Write-Host ""
    ...
    Write-Host "Key steps for Use Performance Monitor:" -ForegroundColor Cyan
