...
.DESCRIPTION
    ...
    Demonstrates Network ATC for simplified cluster networking.
...
try {
    Write-Host "[Step 1] Configure Network ATC - Overview" -ForegroundColor Yellow
    Write-Host "Demonstrates Network ATC for simplified cluster networking." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Configure Network ATC..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Configure Network ATC..." -ForegroundColor Cyan
