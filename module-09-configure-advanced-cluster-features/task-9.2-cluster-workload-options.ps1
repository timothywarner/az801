...
.DESCRIPTION
    ...
    Shows different cluster workload types and configurations.
...
try {
    Write-Host "[Step 1] Configure Cluster Workload Options - Overview" -ForegroundColor Yellow
    Write-Host "Shows different cluster workload types and configurations." -ForegroundColor White
    Write-Host ""
    
    Write-Host "[Step 2] Prerequisites Check" -ForegroundColor Yellow
    Write-Host "Checking prerequisites for Configure Cluster Workload Options..." -ForegroundColor Cyan
    ...
    Write-Host "Configuring Configure Cluster Workload Options..." -ForegroundColor Cyan
